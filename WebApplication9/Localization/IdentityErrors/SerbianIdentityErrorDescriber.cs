...
namespace WebApplication9.Localization.IdentityErrors
{
    public class SerbianIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError InvalidEmail(string email) { return new IdentityError { Code = nameof(InvalidEmail), Description = $"Imejl '{email}' nije validan." }; }
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"Imejl '{userName}' je već u upotrebi." }; } //namerno stavljam imejl umesto username
        public override IdentityError DuplicateEmail(string email) { return new IdentityError { Code = nameof(DuplicateEmail), Description = $"Imejl '{email}' je već u upotrebi." }; }
        ...
        public override IdentityError PasswordTooShort(int length) { return new IdentityError { Code = nameof(PasswordTooShort), Description = $"Dužina lozinke mora biti od {length} do 100 karaktera." }; }
