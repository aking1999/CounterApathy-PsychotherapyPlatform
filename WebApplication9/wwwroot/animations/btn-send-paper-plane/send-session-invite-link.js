$(document).ready(function () {
    ...
    const bookingId = $('#BookedSession_BookingId');
    const sessionId = $('#BookedSession_SessionId');
        ...
        button.addEventListener("click", (e) => {
            ...
            setTimeout(function () {
                if ($('#add-invite-link-form').validate().element(inviteLink)) {
                    ...
                    formData.append('details.BookedSession.BookingId', bookingId.val());
                    formData.append('details.BookedSession.SessionId', sessionId.val());

                    $.ajax({
                        url: sessionInviteLinkEndpoint,
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
                                ...
                                setTimeout(function () {
                                    if (!button.classList.contains("active")) {
                                        ...
                                        $('#invite-link-notice-placeholder').fadeOut('fast', function () {
                                            $(this).html(
                                                "<i class='far fa-link mr-2'></i>" + btnLaunchModal.attr('data-contactmethodname') + " link za pristup seansi:" +
