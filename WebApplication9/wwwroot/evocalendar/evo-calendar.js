...
;(function(factory) {
            ...
            _.initials = {
                ...
                dates: {
                    sr: {
                        ...
                        daysShort: ["Ned", "Pon", "Uto", "Sre", "Čet", "Pet", "Sub"],
                        months: ["Januar", "Februar", "Mart", "April", "May", "Jun", "Jul", "August", "Septembar", "October", "Novembar", "December"],
                        monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
                        noEventForToday: "Nema seansi za danas.",
                        noEventForThisDay: "Nema seansi za ovaj dan.",
                        previousYearText: "Prethodna godina",
                        nextYearText: "Naredna godina",
                        closeSidebarText: "Zatvori meni",
                        closeEventListText: "Zatvori listu seansi"
                    },
                    en: {
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        markup += '></div></div><div class="event-info"><span class="event-title"><div class="row"><div class="col-12 col-lg-8">' + _.limitTitle(event_data.name) +'</div>';
        if (event_data.badge) markup += '<div class="col-12 col-lg-4 d-lg-flex justify-content-lg-end"><div><span class="badge badge-soft-primary rounded-pill my-md-2 mt-lg-0 mb-lg-2 px-2 fs--1">' + event_data.badge +'</span></div></div>';
        markup += '</div></span>'
    ...
    EvoCalendar.prototype.addEventIndicator = function (event) {
        ...
        if (event_date instanceof Array) {
            ...
            appendDot(event_date); //ovaj ovde izaziva pojavljivanje vise komada
        }
        ...
        function appendDot(date) {
            ...
            if (thisDate.find('span.event-indicator > .type-bullet').length === 0) {
