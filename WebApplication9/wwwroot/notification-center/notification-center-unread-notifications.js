...
function GetUnreadNotifications() {
    $.ajax({
        ...
        success: function (result) {
            ...
            if (unreadCount === 0) {
                $('#notification-center-content').append('<div class="card"><div class="card-body"><span id="no-new-notification"><center class="text-secondary"><i class="far fa-thumbs-up text-primary mr-2"></i>Nema nepročitanih notifikacija</center></span></div></div>');
            } else {
                ...
                success: setTimeout(function () {
                    ...
                    if (unreadCount === 0) {
                        ...
                        $('#notification-center-content')
                            .append('<div class="card"><div class="card-body"><span id="no-new-notification"><center class="text-secondary"><i class="far fa-thumbs-up text-primary mr-2"></i>Nema nepročitanih notifikacija</center></span></div></div>')
                            .fadeIn('slow');
                    } else {
