(function () {
    ...
    SliderCaptcha.DEFAULTS = {
        ...
        offset: 5,      // 容错偏差
        loadingText: 'Loading...',
        failedText: 'Slide this slider',
        barText: 'Slide this slider',
    ...
    _proto.initDOM = function () {
        ...
        var sliderIcon = createElement('i', 'fas fa-arrow-right sliderIcon');
    ...
    _proto.initImg = function () {
        ...
        img.onerror = function () {
            ...
            if (loadCount >= that.options.maxLoadCount) {
                that.text.textContent = 'Slide this slider';
        ...
        img.setSrc = function () {
            ...
            //if (!src || src === '') src = 'img/' + randomIntFromInterval(1, 6) + '.jpg';
...
function CreateCaptchaModal(modalId) {
    let modal = '<div class="modal theme-modal fade" id="' + modalId + '" aria-modal="true" role="dialog">' +
        '<div class="modal-dialog modal-dialog-centered">' +
        '<div class="modal-content border">' +
        '<div class="modal-header px-card bg-light border-0 flex-between-center">' +
        '<div>' +
        '<h5 class="mb-0 text-center"><i class="far fa-male mr-2 text-primary"></i>Human verification</h5>' +
        '</div>' +
        '<button class="close fs-0 px-card" data-dismiss="modal" aria-label="Close">' +
        '<i class="fas fa-times" focusable="false"></i>' +
        '</button>' +
        '</div>' +
        '<div class="modal-body px-card pb-card">' +
        '<div class="slidercaptcha card">' +
        '<div class="card-header text-center">' +
        '<span>Slide to complete the puzzle</span>' +
        '</div>' +
        '<div class="card-body">' +
        '<div id="captcha"></div>' +
        '</div>' +
