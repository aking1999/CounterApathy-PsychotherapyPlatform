    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (notificationCount === 0) {
                $('#notification-section-dropdown-content').append('<span id="no-new-notification"><br /><center class="text-secondary">Nema nepročitanih notifikacija</center><br /></span>');
            }
            else {
                    ...
                    if (Number(counter.attr('data-count')) === 0) {
                        anchorClone.promise().done(function () {
                            $('#notification-section-dropdown-content')
                                .append('<span id="no-new-notification"><br /><center class="text-secondary">Nema nepročitanih notifikacija</center><br /></span>')
                                .fadeIn('slow');
